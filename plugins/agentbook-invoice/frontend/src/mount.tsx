/**
 * UMD Mount Entry for AgentBook Invoice Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginAgentbookInvoice';
...
export const metadata = (plugin as any).metadata || { name: 'agentbook-invoice', version: '1.0.0' };
