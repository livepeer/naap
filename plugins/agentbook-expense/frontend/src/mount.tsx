/**
 * UMD Mount Entry for AgentBook Expense Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginAgentbookExpense';
...
export const metadata = (plugin as any).metadata || { name: 'agentbook-expense', version: '1.0.0' };
