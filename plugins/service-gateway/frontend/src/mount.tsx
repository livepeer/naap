/**
 * UMD Mount Entry for Service Gateway Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginServiceGateway';

export const mount = plugin.mount;
export const unmount = (plugin as any).unmount;
export const getContext = (plugin as any).getContext;
export const metadata = (plugin as any).metadata || { name: 'serviceGateway', version: '1.0.0' };
