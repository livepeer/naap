/**
 * UMD Mount Entry for AgentBook Tax & Reports Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginAgentbookTax';
...
export const metadata = (plugin as any).metadata || { name: 'agentbook-tax', version: '1.0.0' };
