...
// Auto-generated by bin/sync-plugin-registry.ts from each plugin's
// plugin.json frontend.routes — do NOT hardcode entries here.
import PLUGIN_ROUTE_MAP from './generated/plugin-routes.json';
