...
| 5 | livepeer-naap-api | Livepeer NAAP API | ai | none | passthrough | envelope | no |
...
### 5. Livepeer NAAP API (`livepeer-naap-api`)
...
|----------|-------------------|
| passthrough | openai, gemini, daydream, livepeer-studio, livepeer-naap-api, cloudflare-ai, clickhouse, neon, pinecone, supabase (JSON), upstash-redis, resend, confluent-kafka, ssh-bridge, clickhouse-query (dynamic) |
...
| envelope | openai, gemini, daydream, livepeer-studio, livepeer-naap-api, cloudflare-ai, clickhouse, clickhouse-query, neon, pinecone, supabase, resend, confluent-kafka, storj-s3, ssh-bridge |
