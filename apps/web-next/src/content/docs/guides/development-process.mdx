...
NaaP deploys to **Vercel** (staging + production). Plugins are built as UMD bundles and served from the same origin. Understanding the deployment model prevents the most common breakages.
