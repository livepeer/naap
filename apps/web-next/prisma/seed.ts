...
async function main() {
  ...
  const marketplacePlugins = [
    ...
    },
    {
      ...
      description: 'Dashboard data provider backed by the Livepeer Leaderboard API, subgraph, and L1 RPC. Serves live network data via the GraphQL-over-event-bus contract.',
      category: 'analytics',
      author: 'NAAP Team',
      authorEmail: 'team@naap.io',
