/**
 * UMD Mount Entry for Marketplace Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginMarketplace';

export const mount = plugin.mount;
export const unmount = (plugin as any).unmount;
export const getContext = (plugin as any).getContext;
export const metadata = (plugin as any).metadata || { name: 'marketplace', version: '1.0.0' };
