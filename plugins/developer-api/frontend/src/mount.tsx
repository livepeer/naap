/**
 * UMD Mount Entry for Developer API Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginDeveloperApi';

export const mount = plugin.mount;
export const unmount = (plugin as any).unmount;
export const getContext = (plugin as any).getContext;
export const metadata = (plugin as any).metadata || { name: 'developerApi', version: '1.0.0' };
