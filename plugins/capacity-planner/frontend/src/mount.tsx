/**
 * UMD Mount Entry for Capacity Planner Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginCapacityPlanner';

export const mount = plugin.mount;
export const unmount = (plugin as any).unmount;
export const getContext = (plugin as any).getContext;
export const metadata = (plugin as any).metadata || { name: 'capacityPlanner', version: '1.0.0' };
