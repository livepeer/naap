...
- Frontend: React 18+, TypeScript, Tailwind CSS, Vite (UMD bundle)
- Backend: Express.js, TypeScript, Prisma ORM
- Database: PostgreSQL (via Prisma)
- Shell integration: @naap/plugin-sdk
- Backend runs on its own port, shell proxies API calls to /api/v1/[plugin-name]/*
...
5. Frontend requirements:
   ...
   - Use usePluginApi() for all API calls
